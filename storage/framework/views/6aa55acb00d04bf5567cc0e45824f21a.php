    ...
    <div class="message-card">
        <div class="message-info">
            <div class="info-item">
                ...
                <span class="info-value"><?php echo e($message->name); ?></span>
            </div>
            <div class="info-item">
            ...
            <div class="info-item">
                ...
                <span class="info-value"><?php echo e($message->created_at->format('F d, Y h:i A')); ?></span>
            </div>
            <div class="info-item">
        ...
        <div class="message-actions">
            <a href="<?php echo e(route('admin.messages.index')); ?>" class="btn-back">← Back to Messages</a>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\md-julfikar-hasan-v2\resources\views/admin/messages/show.blade.php ENDPATH**/ ?>