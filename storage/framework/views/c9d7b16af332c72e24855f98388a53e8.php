    ...
    <div class="container">
            ...
            <a href="<?php echo e(route('about')); ?>" class="profile-card large-card card-link">
                <div class="profile-content">
                    <div class="profile-image">
                        ...
                        <img src="<?php echo e(asset('assets/images/profile.jpg')); ?>" alt="Md. Shadman Hasin">
                    </div>
                    <div class="profile-info">
                        <span class="role"><?php echo e($settings['role'] ?? 'WEB ENGINEER'); ?></span>
                        <h1><?php echo e($settings['name'] ?? 'Md. Shadman Hasin'); ?></h1>
                        <p><?php echo e($settings['bio'] ?? 'Web Engineer • Full Stack Developer • UI/UX Enthusiast'); ?></p>
        ...
        <div class="grid-row">
            <div class="stats-card">
                ...
                <div class="stat-item">
                    <span class="stat-number"><?php echo e($settings['projects_count'] ?? '10+'); ?></span>
