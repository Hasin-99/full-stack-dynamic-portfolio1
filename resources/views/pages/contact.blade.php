    ...
    <section class="contact-section">
        ...
        <div class="contact-content">
            <div class="contact-info">
                <h3>Get in Touch</h3>
                {{-- Updated Fallbacks to your specific details --}}
                <p>📨 Email: {{ $settings['email'] ?? 'hasin22205101462@diu.edu.bd' }}</p>
                <p>📱 Mobile: {{ $settings['phone'] ?? '01764851551' }}</p>
                <p>🌍 Location: {{ $settings['location'] ?? 'YKSG-01, Ashulia, Savar, Dhaka' }}</p>
                
                <div class="social-links">
                    <h4>Connect with me</h4>
                    <div class="social-grid">
                        {{-- GitHub --}}
                        <a href="{{ $settings['github_url'] ?? 'https://github.com/Hasin-99' }}" target="_blank" class="social-link" title="GitHub">
                        ...
                        {{-- LinkedIn --}}
                        <a href="{{ $settings['linkedin_url'] ?? 'https://www.linkedin.com/in/md-shadman-hasin-648587333' }}" target="_blank" class="social-link" title="LinkedIn">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
...
@section('footer')
    <footer>
        <div class="footer-content">
            ...
            <p class="copyright">&copy; {{ date('Y') }} Md. Shadman Hasin. All rights reserved.</p>
        </div>
    </footer>
@endsection
